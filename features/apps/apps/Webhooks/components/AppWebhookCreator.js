...
class AppWebhookCreator extends React.Component {
        ...
        try {
            ...
            if (this.props.sendKeyTo) {
                ...
                window.location.replace(
                    `${this.props.sendKeyTo}?key=${hook.token}&url=${root}/tasks/apps/nodehost?success=true`
                );
            }
    ...
    render() {
        if (
            ...
            return (
                <h3>
                    Redirecting you to the application. This may take a few
                    moments.
                </h3>
            );
