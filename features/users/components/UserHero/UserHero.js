				...
				<div className="hero-body" style={this.getHeaderCss(true)}>
					...
					<div className={"container"}>
						<div className="UserHero-Media">
							<div className={"flex"}>
								<div className={"UserHero-Avatar is-hidden-mobile"}>
									<img src={props.user.avatar} alt={props.user.username} style={{
										maxWidth: 150,
										maxHeight: 150,
										height: 'auto',
										width: '100%'
								...
								<div>
									{props.featured &&
									<strong><Emoji emoji={"✨"}/> Featured user</strong>}
									{props.user.verified &&
									<strong><FontAwesomeIcon icon={'check'}/> Verified</strong>}
									<h3>
