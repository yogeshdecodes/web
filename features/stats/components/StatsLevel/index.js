...
class UserStatsLevel extends React.Component {
    render() {
        ...
        if (
            this.props.doneToday !== undefined &&
            this.props.streak !== undefined &&
            this.props.remainingTasks !== undefined &&
            this.props.tda !== undefined
        ) {
            return (
                        ...
                        <React.Fragment>
                            <div className={"flex end"}>
                                <div className={"hero-item"}>
                                    <p className={"heading"}>
                                        <FontAwesomeIcon icon={"fire"} /> Streak
                                    </p>
                                    <Streak
                                        days={this.props.streak}
                                        endingSoon={this.props.streakEndingSoon}
                                    />
                                </div>
                                <div className={"hero-item"}>
                                    <p className={"heading"}>
                                        <FontAwesomeIcon icon={"bed"} /> Rest
                                        days
                                    </p>
                                    <Emoji emoji={"😴️"} />{" "}
                                    {this.props.restDayBalance
                                        ? this.props.restDayBalance
                                        : 0}
                                </div>
                                <div className={"hero-item"}>
            ...
            return (
                <div>
                    ...
                    <button onClick={this.props.refreshStats}>
                        Reload stats
                    </button>
                </div>
            );
