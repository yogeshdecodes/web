...
export async function deleteReply(id, threadSlug) {
    try {
        const response = await axios.delete(`/discussions/${threadSlug}/replies/${id}`);
        return response.data;
    } catch (e) {
        prettyAxiosError(e)
    }
...
export async function updateReply(threadSlug, id, payload) {
    try {
        const response = await axios.patch(`/discussions/${threadSlug}/replies/${id}/`, payload);
        return response.data;
    } catch (e) {
        prettyAxiosError(e)
    }
...
export async function postReply(threadSlug, body, parentReply=null) {
    try {
        ...
        const response = await axios.post(`/discussions/${threadSlug}/replies/`, payload);
        return response.data;
    } catch (e) {
        prettyAxiosError(e)
    }
...
export const createThread = async (type, title, body) => {
    /**
