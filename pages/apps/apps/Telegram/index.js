			...
			<div>
				<div className={"hero dark"} style={style}>
					<div className={"container"}>
						...
						<h3>
							Your awesome Telegram bot for Makerlog. Add done tasks from your messenger and check your
							stats.
						</h3>
					</div>
				</div>
				<div className={"container"}>
					...
					<div className={"card"}>
						<div className={"card-content has-text-centered"}>
							<h3 className={"has-text-grey"}>Click the button below to get started.</h3>
							<OutboundLink className={"button is-medium is-info"} to={"http://telegram.me/MakerlogBot"}>
								Add to Telegram
							</OutboundLink>
							<hr/>
							<small>You can also <OutboundLink to={'https://t.me/makerlog'}>join the Makerlog
								groupchat</OutboundLink> to interact with other makers.
							</small>
						</div>
					</div>
				</div>
