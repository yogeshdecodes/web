            ...
            <div>
                <div className={"hero dark"} style={style}>
                    <div className={"container"}>
                        <h2>GitHub</h2>
                        <h3>
                            Log your commits and closed issues from GitHub
                            instantly.
                        </h3>
                    </div>
                </div>
                ...
                <section className={"container"}>
                    ...
                    <div className={"card"}>
                        <div className={"card-content"}>
                            ...
                            webhook to link it to a GitHub repository. We'll
                            start tracking events like commits and issues
                            afterwards.
                            <br />
                    ...
                    <div className={"card"}>
                        <div className={"card-content"}>
                            {this.props.apps["github"].installed && (
                                <WebhookTable
                                    webhooks={
                                        this.props.apps["github"].webhooks
                                    }
                                />
                            )}
                            {!this.props.apps["github"].installed && (
